...
from neural_image_assessment.utils.score_utils import mean_score, std_score
...
def evaluate(images_dirs, model_path):
    # give priority to directory
    if images_dirs is not None:
        print("Loading images from directory : ", images_dirs)
        imgs, diff = get_image_paths(images_dirs)
